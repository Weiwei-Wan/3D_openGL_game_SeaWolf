...
GLuint generateObjectBuffer(GLfloat vertices[], GLfloat colors[]) {
    ...
    // if you have more data besides vertices (e.g., vertex colours or normals), use glBufferSubData to tell the bufferwhen the vertices array ends and when the colors start
